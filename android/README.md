...
当前为 **UI-R2 统一工作台开发版**（`0.0.11-ui-r2`）：可视化模板创建、双层编辑工具、框选／稳线、共享摘要、知识关联、局部图、集合与手动回忆。当前实现与验证边界见 [UI-R2 实施记录](UI-R2-IMPLEMENTATION.md) 和 [修改日志](CHANGELOG.md)，开发顺序见 [待实现内容](TODO.md)，既有学习数据合同见 [A3.5 说明](A3.5-LEARNING.md)。
